...
pkgrel=250501
_build=250501
pkgdesc="Software for Amateur Radio Weak-Signal Communication (JT9 and JT65) - WSJT-X Improved by DG2YCB (Additional Logger version)"
...
provides=('wsjtx')
conflicts=('wsjtx')
source=("https://downloads.sourceforge.net/project/wsjt-x-improved/WSJT-X_v$pkgver/Source%20code-AL/$_pkgname-${pkgver}_improved_AL_PLUS_${_build}.tgz")
